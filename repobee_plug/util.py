...
class RepoBeeExtensionParser(argparse.ArgumentParser):
    ...
    def __new__(
        ...
        Args:
            ...
            requires_api: If True, the base arguments required for the platform
                ...
                place of the API.
        """
        if not isinstance(parser, RepoBeeExtensionParser):
            raise exception.ExtensionCommandError(
                "parser must be a {.__class__.__name__}".format(RepoBeeExtensionParser)
            )
